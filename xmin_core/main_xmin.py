...
def main_xmin(city_name: str):
    ...
    city_polygon, city_bboxes, est_utm_crs = get_city_bboxes(city_name) # pd.DataFrame, columns: minx, miny, maxx, maxy, mode, timeframe
    ...
    # city_pois_cates_files = get_city_pois_categories(city_bboxes, est_utm_crs, savedir)
    #
